		...
		<div class="contents">
			<div class="login">
				...
				<form name="newMember" class="form-signin" action="/Lib/findidd" method="post" onsubmit="return checkForm()">
					...
					<p>
						<button class="btn btn btn-lg btn-success btn-block" type="submit">아이디 조회</button>
					</p>
				</form>

				<a href="/Lib/loginpage">로그인 </a> / <a href="/Lib/findpw">비밀번호 찾기</a>
			</div>
			<center>
				<p>
